...
design_libs=(axis_infrastructure_v1_1_0 axis_data_fifo_v2_0_10 xil_defaultlib)
...
compile()
{
  vlogan -work axis_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
  "../../../ipstatic/hdl/axis_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee compile.log; cat .tmp_log > vlogan.log 2>/dev/null

  vlogan -work axis_data_fifo_v2_0_10 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
  "../../../ipstatic/hdl/axis_data_fifo_v2_0_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
...
reset_run()
{
  files_to_remove=(ucli.key axis_data_fifo_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axis_data_fifo_0_simv.daidir vcs_lib c.obj)
