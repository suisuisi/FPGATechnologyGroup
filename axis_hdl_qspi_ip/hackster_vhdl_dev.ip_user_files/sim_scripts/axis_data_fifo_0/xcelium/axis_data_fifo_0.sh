...
#
# Script generated by Vivado on Tue Sep 05 16:31:56 +0100 2023
...
#
# Usage        : axis_data_fifo_0.sh
#                axis_data_fifo_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axis_data_fifo_0.sh [-reset_run]
#                axis_data_fifo_0.sh [-reset_log]
#                axis_data_fifo_0.sh [-help]
#
...
#                script (type 'axis_data_fifo_0.sh -help' for more information).
#
...
design_libs_elab="-libname axis_infrastructure_v1_1_0 -libname axis_data_fifo_v2_0_10 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver axis_infrastructure_v1_1_0 axis_data_fifo_v2_0_10 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axis_data_fifo_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axis_data_fifo_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work axis_infrastructure_v1_1_0 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
  "../../../ipstatic/hdl/axis_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee compile.log; cat .tmp_log > xmvlog.log 2>/dev/null

  xmvlog -work axis_data_fifo_v2_0_10 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
  "../../../ipstatic/hdl/axis_data_fifo_v2_0_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axis_data_fifo_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axis_data_fifo_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axis_data_fifo_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: axis_data_fifo_0.sh [-step]\n\
Usage: axis_data_fifo_0.sh [-lib_map_path]\n\
Usage: axis_data_fifo_0.sh [-reset_run]\n\
Usage: axis_data_fifo_0.sh [-reset_log]\n\
Usage: axis_data_fifo_0.sh [-keep_index]\n\
