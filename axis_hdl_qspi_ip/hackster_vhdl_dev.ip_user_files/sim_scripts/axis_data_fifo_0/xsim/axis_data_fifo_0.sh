...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axis_infrastructure_v1_1_0 -L axis_data_fifo_v2_0_10 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axis_data_fifo_0 xil_defaultlib.axis_data_fifo_0 xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axis_data_fifo_0.wdb xsim.dir libdpi.so)
