...
module conv_round_cc(AIN, BIN, CIN, CLK, RST, ROUND_OUT);
...
input CLK;
input RST;
output [43:0] ROUND_OUT;

wire [47:0] POUT1;
reg[47:0] CIN_REG, ROUND_OUT_INT;
wire PDOUT;
...
begin
       ...
       ROUND_OUT_INT <= POUT1[47:4] + PDOUT;
end


assign ROUND_OUT = ROUND_OUT_INT;
