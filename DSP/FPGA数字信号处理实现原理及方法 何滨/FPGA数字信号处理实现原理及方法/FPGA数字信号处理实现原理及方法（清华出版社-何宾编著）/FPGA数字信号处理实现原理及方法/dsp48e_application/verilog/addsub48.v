...
// The output is A_IN + C_IN when ADD_SUB = 0 and
// C_IN - A_IN when ADD_SUB = 1;. 
// 
//
...
module addsub48 (CLK, RST, A_IN, C_IN, ADD_SUB, ADDSUB48_OUT);
	
input           CLK, RST;
input   [47:0]  A_IN, C_IN;
input           ADD_SUB;
output  [47:0]  ADDSUB48_OUT;
