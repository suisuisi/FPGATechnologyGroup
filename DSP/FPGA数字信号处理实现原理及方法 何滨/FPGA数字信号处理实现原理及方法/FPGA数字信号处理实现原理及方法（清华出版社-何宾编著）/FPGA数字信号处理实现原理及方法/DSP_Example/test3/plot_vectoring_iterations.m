% script to plot the rotations of a CORDIC engine in vectoring mode
...
for i = k:m-1 
    ...
    % provide a title...
    title('Vectoring Mode Iterations');
    
    % add a legend at the right hand side
    % create a cell array containing the required strings
    legend_matrix = cell(1,n); 
    legend_matrix(1,1) = {'Input'};
    for s = 2:n
        legend_matrix(1,s) = {['Iteration ', num2str(s-1)]};
    end
